        ...
        <div class="section-top-border">
            ...
            <div class="row mb-10">
                ...
                <div class="col-md-4 text-center">
                    <form action="{{ route('update_panel.tugaspanel', $panel->id ) }}" method="post"
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row mb-10">
                        <div class="col-md-2 offset-md-8">
                            <a href="{{ route('edit_tugas.tugaspanel', $value->id )}}"
                                class="genric-btn info btn-block text-center openPopup">Edit</a>
                        </div>
                        <div class="col-md-2">
                            <form action="{{ route('destroy_tugas.tugaspanel', $value->id )}}" method="post">
                    ...
                    <div class="row mb-10">
                        <div class="col-md-2 offset-md-8">
                            <a href="javascript:void(0);" data-href="{{ route('change_file.tugaspanel', $value->id) }}"
                                class="genric-btn info btn-block text-center openPopup">Edit</a>
                        </div>
                        <div class="col-md-2">
                            <form action="{{ route('destroy_file.tugaspanel', $value->id )}}" method="post">
                                <input class="genric-btn danger btn-block text-center" type="submit" value="Delete"
                                    onclick="return confirm('Are you sure you want to delete this item?');" />
                                @method('delete')
                                @csrf
                    ...
                    <blockquote class="generic-blockquote">
                        <p><a href="{{route('download.tugasonpanel', $value->id) }}"><i
